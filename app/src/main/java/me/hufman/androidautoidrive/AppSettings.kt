...
object AppSettings {
	...
	private val DEFINITIONS = mapOf(
		...
		KEYS.AUDIO_AUTOMATIC_CONTEXT to SettingDefinition("Audio_Automatic_Context", BuildConfig.AUTOMATIC_AUDIO_CONTEXT.toString(), "Guess the Audio Context setting"),
